...
def inject_lucelec_loading_screen():
    """
    Injects a full-screen LUCELEC loading overlay that masks Streamlit's rerun state.
    Features:
      - Blue square box with LUCELEC logo
      - Continuous left-to-right-to-left fade & glide animation
      - Classic 3-dot pulse animation below the logo box
    """
    import streamlit as st
    loading_html = """
    <style>
        ...
        /* Full-screen Loading Mask Overlay */
        ...
        /* Show overlay whenever Streamlit triggers a run/rerun */
        ...
        .lucelec-logo-box {
            ...
            align-items: center;
            padding: 16px;
            /* Left to Right to Left Fade & Glide Animation */
            animation: sweepLeftRightLeft 2.4s ease-in-out infinite;
        }
        ...
        /* Keyframe Animation: Fade in & sweep Left -> Right -> Left */
        @keyframes sweepLeftRightLeft {
            0% {
        ...
        /* Classic Loading Dots Container */
        .lucelec-dots-container {
            display: flex;
            align-items: center;
            gap: 10px;
            margin-top: 28px;
        ...
        .lucelec-dot {
            ...
            animation: classicDotPulse 1.4s infinite ease-in-out both;
        }

        /* Staggered Dot Animation Delays */
        .lucelec-dot:nth-child(1) { animation-delay: 0.0s; }
        .lucelec-dot:nth-child(2) { animation-delay: 0.2s; }
        .lucelec-dot:nth-child(3) { animation-delay: 0.4s; }

        @keyframes classicDotPulse {
            0%, 80%, 100% {
                transform: scale(0.6);
                opacity: 0.3;
            }
    ...
    <div class="lucelec-loading-overlay">
        ...
        <div class="lucelec-dots-container">
            <span class="lucelec-dot"></span>
            <span class="lucelec-dot"></span>
            <span class="lucelec-dot"></span>
        </div>
    </div>
